            ...
            try
            {
                ...
                switch ((EnumInstrucoes_Bradesco)idInstrucao)
                {
                    case EnumInstrucoes_Bradesco.Protestar:
                        ...
                        this.Descricao = "** VALORES EXPRESSOS EM REAIS  -  AS INFORMACOES DESTE BOLETO SAO DE EXCLUSIVA RESP DO CEDENTE E CORRESPONDE A TX   O PAGAMENTO DESTE BOLETO NAO QUITA PARCELAS EM ABERTO ANTERIORES.      EVITE O DESLIGAMENTO POR FALTA DE PAGAMENTO APOS 120 DIAS.";
                        break;
